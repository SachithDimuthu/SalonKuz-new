 ...
 * Add Service
 * 
 * This page allows administrators to add a new service.
 */
                        ...
                        <form action="add-service.php" method="POST" enctype="multipart/form-data">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="price" id="price" min="0" step="0.01" value="<?php echo isset($price) ? $price : ''; ?>" class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring focus:ring-pink-500 focus:ring-opacity-50" required>
                                </div>
                                
                                <!-- Duration -->
                                <div>
                                    <label for="duration" class="block text-sm font-medium text-gray-700 mb-1">Duration (minutes) *</label>
                                    <input type="number" name="duration" id="duration" min="5" step="5" value="<?php echo isset($duration) ? $duration : '30'; ?>" class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring focus:ring-pink-500 focus:ring-opacity-50" required>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_active" id="is_active" class="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300 rounded" <?php echo (!isset($isActive) || $isActive) ? 'checked' : ''; ?>>
